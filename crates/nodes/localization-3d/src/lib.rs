...
pub struct SolveDiagnostics {
    ...
    pub global_visual_reprojection: SolveResidualDiagnostics,
    pub pose_hint_visual_reprojection: SolveResidualDiagnostics,
...
impl From<BackendSolveDiagnostics> for SolveDiagnostics {
    fn from(diagnostics: BackendSolveDiagnostics) -> Self {
        Self {
            ...
            global_visual_reprojection: diagnostics.global_visual_reprojection.into(),
            pose_hint_visual_reprojection: diagnostics.pose_hint_visual_reprojection.into(),
